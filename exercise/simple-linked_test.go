...
func BenchmarkNewSimpleList(b *testing.B) {
	if testing.Short() {
		b.Skip("skipping benchmark in short mode.")
	}
	for i := 0; i < b.N; i++ {
		_ = NewSimple(array1To10)
	}
}
